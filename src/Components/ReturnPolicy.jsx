...
function ReturnPolicy() {
  return (
      <div className=" py-2 ">
        ...
        <section>
          <ol className="d-flex flex-column gap-2 px-5" style={{textAlign:"justify"}}>
            <li>
          ...
          <div className="d-flex flex-column gap-1 px-5">
            <span>Note: If you've received a non-returnable product in a damaged defective condition,you can contact us within 5 days from the delivery of the product.</span>
            <span>Note: All product categories are non-returnable for International Customers for Expert Orders.</span>
        </div>
        </section>
      </div>
